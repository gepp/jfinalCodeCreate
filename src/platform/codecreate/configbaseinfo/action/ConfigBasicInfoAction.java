	...
	public void saveAdd() {
		...
		if (fieldEnglishNames != null && fieldEnglishNames.length > 0) {
			for (int i = 0; i < fieldEnglishNames.length; i++) {
				...
				if("CHAR".equalsIgnoreCase(fieldType)||"TEXT".equalsIgnoreCase(fieldType)||"VARCHAR".equalsIgnoreCase(fieldType)||"TEXT".equalsIgnoreCase(fieldType)||"binary".equalsIgnoreCase(fieldType)||"BLOB".equalsIgnoreCase(fieldType)||"longtext".equalsIgnoreCase(fieldType)){
					objectType="String";
				}
				else if("INT UNSIGNED".equalsIgnoreCase(fieldType)||"INT".equalsIgnoreCase(fieldType)||"TINYINT".equalsIgnoreCase(fieldType)||"SMALLINT".equalsIgnoreCase(fieldType)||"MEDIUMINT".equalsIgnoreCase(fieldType)){
					objectType="Integer";
				}
				...
				configBasicExtendInfo.set("FIRSTLOW_ENGLISH_NAME",PlatformTool.toFirstLowerString(PlatformTool.conversionObject(fieldEnglishName)));
